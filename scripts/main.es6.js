...
class StickyNotesApp {
  ...
  saveNote() {
    if (this.noteMessageInput.value) {
      let key = Date.now();
      localStorage.setItem(key.toString(), this.noteMessageInput.value);
...
let CLASSES = ['mdl-cell--4-col-desktop', 'mdl-card__supporting-text', 'mdl-cell--12-col',
